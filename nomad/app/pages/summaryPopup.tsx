...
export default function MarkerPopup({ location, onClose }: Props) {
  return (
    <View style={styles.bottomPopup}>
      <Text style={styles.popupTitle}>{location.title}</Text>
      {location.summary && (
        <Text style={styles.popupSummary}>{location.summary}</Text>
      )}
